...
let allHrsArray1 = [...allHrs];


// Set the border of the all the hr elements to "1px solid tomato"

let allHrLine = allHrsArray.forEach((eachHr) => eachHr.style.border = '1px solid tomato') ;

// Change the background of all the hr to "antiquewhite" using for of loop.


let allBorderRadius = allHrsArray.forEach((eachHr) => eachHr.style.backgroundColor = 'antiqueWhite') ;


// Change the 'border-radius' of all the hr to "5px" using array.

let allBorderadius = allHrsArray.forEach((eachHr) => eachHr.style.borderRadius = '5px') ;
...
let allHrImg = allHrsArray.forEach((eachHr) => eachHr.style.border = '2px solid purple') ;
...
let dashedBorder = allHrs.forEach((eachHr) => eachHr.style.borderStyle = 'dashed');
...
let allBoxHrOne = document.querySelectorAll('.one');
allBoxHrOne.innerHTML = '';

// Replace all the elements inside box 1 with the para (you created above)

allBoxHrOne.append(para)
...
console.log(box16.firstChild) //text
console.log(box16.lastChild) // last text before </div>

console.log(box16.previousElementSibling)
console.log(box16.nextElementSibling)
console.log(box16.firstElementChild) // first hr
console.log(box16.lastElementChild) // last hr before </div>
...
let prepenedPara = document.createElement('p').innerText = 'Prepend inserts as first child'
box3.prepend(prepenedPara);
...
let btn = body.forEach((eachHr) => eachHr.style.backgroundColor = 'bisque') ;
...
let anchorElmOne = document.createElement('a')
let anchorElmTwo = document.createElement('a')
anchorElmOne.innerText = 'AltCampus'
anchorElmTwo.innerText = 'Google'

// Change the href property of the anchor elements to `https://altcampus.school` and `https://google.com`

anchorElmOne.href = 'https://altcampus.school'
anchorElmTwo.href = 'https://google.com'

// Append both the elements to box 5 you selected above.

box5.append(anchorElmOne,anchorElmTwo);
